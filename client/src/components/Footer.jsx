...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-blue-600 to-teal-700 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm">Email: info@thelocalbasket@gmail.com</p>
          </div>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <Input
                ...
                className="bg-white text-green-800 placeholder-green-600 border-white-500 focus:border-blue-400"
              />
        ...
        <div className="mt-8 pt-8 border-t border-white-500 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="text-sm">
            © {new Date().getFullYear()} EazxGrozy. All rights reserved.
          </p>
          <p className="text-sm flex gap-2  text-white-300">
