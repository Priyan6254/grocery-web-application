...
export default function HomePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-400 to-teal-500 rounded-lg shadow-lg p-8 mb-12">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-bold text-white mb-4">
            Welcome to EazyGrozy
          </h1>
      ...
      <section className="text-center mb-12">
        ...
        <Link to={"/products"}>
          <Button className="bg-blue-500 hover:bg-green-600 text-white font-bold py-2 px-6 rounded-full text-lg">
            Explore Products
          </Button>
        </Link>
      </section>
