          ...
          <ScrollArea className=" md:h-screen w-auto rounded-md border">
            ...
            <Card className="hidden   md:block w-64 h-fit sticky top-4">
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  <Label className="text-black-700 mb-2 block">
                    Categories
                  </Label>
                  {categories &&
                ...
                <div>
                  <Label className="text-black-700 mb-2 block">Brands</Label>
                  {brands.map((brand) => (
                    <div
                      key={brand}
                      className="flex items-center space-x-2 mb-2"
            ...
            <div className="flex-1">
              {products.length > 0 ? (
                ...
                <Card className="p-8 text-center">
                  <CardTitle className="text-2xl font-semibold text-red-800 mb-4">
                    No Products Found
                  </CardTitle>
