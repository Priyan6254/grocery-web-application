              ...
              <form onSubmit={handleSubmit}>
                ...
                {paymentMethod === "stripe" && (
                  <form className="flex flex-col ">
                    ...
                    <Button
                      ...
                      className="mt-4 w-full  bg-blue-500 hover:bg-green-600 text-white font-bold py-3 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1"
                ...
                {paymentMethod === "cod" && (
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full mt-6 bg-blue-500 hover:bg-green-600 text-white font-bold py-3 rounded-lg transition duration-300 ease-in-out transform hover:-translate-y-1"
                  >
                    {loading && (
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    )}
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="flex justify-between text-lg font-bold">
                ...
                <p className="text-blue-800">${total.toFixed(2)}</p>
              </div>
            </CardContent>
          </Card>
        </div>
