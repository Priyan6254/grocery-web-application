  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
            ...
            {isEditingAddress ? (
              <div className="flex items-center">
                <Input
                  ...
                  className="flex-grow mr-2 border-blue-300 focus:border-green-500 focus:ring-blue-500"
                />
                <Button
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-yellow-500 text-yellow-500 hover:bg-green-50"
                >
                  Update
                </Button>
              </div>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            {cartProducts?.map((product) => (
              <div
                key={product.id}
                className="flex items-center py-4 border-b border-blue-200 last:border-b-0"
              >
                <img
                  src={product.image}
                  alt={product.name}
                ...
                <div className="flex items-center">
                  <Button
                    ...
                    variant="outline"
                    size="icon"
                    className="h-8 w-8 rounded-full p-0 border-blue-500 text-blue-500 hover:bg-blue-50"
                  >
                    <Minus className="h-4 w-4" />
                  </Button>
                  <span className="mx-2 font-semibold text-blue-800">
                    {product.quantity}
                  </span>
                  <Button
                    onClick={() =>
          ...
          <CardFooter className="flex justify-between items-center">
            <div className="text-lg font-semibold text-blue-800">Total:</div>
        ...
        <Button
          onClick={createOrder}
          className="w-full bg-blue-500 hover:bg-green-600 text-white text-lg py-6 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1"
        >
